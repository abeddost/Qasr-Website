...
export default function ProductShareButtons({ productName }: ProductShareButtonsProps) {
  ...
  const shareText = encodeURIComponent(`${productName} - Qasr Möbelhaus`);
  const encodedUrl = encodeURIComponent(shareUrl);

  return (
    <div className="mb-8">
      <h3 className="text-lg font-semibold text-gray-900 mb-4">Teilen</h3>
